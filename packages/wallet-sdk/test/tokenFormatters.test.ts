...
async function main() {
    try {
        ...
        const precisionResult = formatTokenBalance("1234567890000000000", 18, options1);
        ...
        const noSepResult = formatTokenBalance("1234567890000000000000", 18, options2);
        ...
        for (const test of amountTests) {
            const result = formatTokenAmount(test.input, test.decimals, test.symbol);
