...
//               <MotiView animate={{ scale: isRefreshing ? 1.1 : 1 }} transition={{ type: "timing", duration: 300 }}>
//                 <TouchableOpacity onPress={handleRefresh} style={styles.refreshButton} disabled={isRefreshing}>
//                   <RefreshCw size={18} color="#6366f1" style={{ transform: [{ rotate: isRefreshing ? "180deg" : "0deg" }] }} />
//                 </TouchableOpacity>
//               </MotiView>
//             </View>
