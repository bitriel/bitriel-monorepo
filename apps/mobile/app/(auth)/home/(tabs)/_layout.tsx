      ...
      <View style={{ flex: 1 }}>
        <Tabs
          ...
          <Tabs.Screen
            ...
            options={{
              headerTitle: "Wallet",
              tabBarIcon: ({ color, size }) => <Iconify icon="solar:wallet-money-bold-duotone" size={size} color={color} />,
              tabBarLabel: "Wallet"
            }}
          />
          ...
          <Tabs.Screen
            ...
            options={{
              ...
              tabBarIcon: ({ color, size }) => <Iconify icon="solar:square-transfer-vertical-bold-duotone" size={size} color={color} />,
              tabBarLabel: "Swap",
              href: null
            }}
          />
          ...
          <Tabs.Screen
            ...
            options={{
              headerTitle: "DApps",
              tabBarIcon: ({ color, size }) => <Iconify icon="solar:shield-network-bold-duotone" size={size} color={color} />,
              tabBarLabel: "DApps",
              href: null
            }}
          />
