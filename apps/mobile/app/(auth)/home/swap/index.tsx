...
export default function SwapScreenCustodial() {
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      const isTokenToStablecoin = state.fromToken.token.address !== KHR_TOKEN.address && state.toToken.token.address === KHR_TOKEN.address;
      const isStablecoinToToken = state.fromToken.token.address === KHR_TOKEN.address && state.toToken.token.address !== KHR_TOKEN.address;
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
            <MotiView
              ...
              <View style={styles.header}>
                ...
                <MotiView animate={{ scale: state.isRefreshing ? 1.1 : 1 }} transition={{ type: "timing", duration: 300 }}>
                  <TouchableOpacity onPress={fetchBalances} style={styles.refreshButton} disabled={state.isRefreshing}>
                    <RefreshCw size={18} color="#6366f1" style={{ transform: [{ rotate: state.isRefreshing ? "180deg" : "0deg" }] }} />
                  </TouchableOpacity>
                </MotiView>
              </View>
              ...
              <View style={styles.swapCardContainer}>
                <BlurView intensity={10} tint="light" style={styles.swapCard}>
                  ...
                  <View style={styles.swapButtonContainer}>
                    <MotiView animate={{ rotate: "0deg" }} transition={{ type: "timing", duration: 300 }} style={styles.swapButtonWrapper}>
