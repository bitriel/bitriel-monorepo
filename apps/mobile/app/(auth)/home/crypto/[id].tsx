      ...
      {loading ? (
        ...
        <>
          ...
          <SectionList
            ...
            ListHeaderComponent={() => (
              <>
                <View className="flex-row justify-between items-center m-5" style={{ marginTop: Platform.OS === "android" ? 60 : 0 }}>
                  <Text className="font-SpaceGroteskSemiBold text-2xl text-defaultText">{coinInfo[id!]?.symbol}</Text>
                ...
                <View style={[defaultStyles.block, { height: 500 }]}>
                  {coinTicker && (
                    <>
                      {!isActive && (
                        <View>
                          <Text className="text-3xl font-SpaceGroteskBold text-darkBlue">{coinTicker[coinTicker.length - 1]["high"]} $</Text>
                      ...
                      <CartesianChart
                        ...
                        {({ points }) => (
                          <>
                            <Line points={points.high} color={Colors.yellow} strokeWidth={3} />
