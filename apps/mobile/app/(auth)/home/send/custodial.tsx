                ...
                <ScrollView className="flex-1">
                    {tokens.length > 0 ? (
                                ...
                                <View className="flex-row items-center">
                                    {token.logo ? (
                                        ...
                                        <View style={styles.tokenLogoPlaceholder}>
                                            <Text className="text-white font-SpaceGroteskMedium">
                                                {token.symbol[0]}
                                            </Text>
                                        </View>
                                    )}
                                    <View className="ml-4 flex-1">
                                        ...
                                        <Text className="text-sm text-gray-500 font-SpaceGroteskRegular">
                                            {token.symbol}
                                        </Text>
                                    </View>
                        ...
                        <View style={styles.noTokensContainer}>
                            <Text className="text-gray-500 text-center font-SpaceGroteskMedium">
                                No tokens available
                            </Text>
                        </View>
                    )}
