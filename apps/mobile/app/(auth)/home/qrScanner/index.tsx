...
const QRScanner: React.FC = () => {
  ...
  if (hasPermission === false) {
    return (
      <View className="flex-1 items-center justify-center">
        <Text className="font-SpaceGroteskSemiBold text-center mx-12">Camera permission denied. Please enable it in your device settings.</Text>
  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <View className="absolute left-0 right-0 flex-row justify-between items-center px-10" style={{ bottom: bottom + 30 }}>
