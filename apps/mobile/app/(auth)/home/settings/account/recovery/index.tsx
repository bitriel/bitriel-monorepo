        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <View className="bg-red-500/20" style={styles.warningContainer}>
              <Iconify icon="solar:danger-circle-line-duotone" size={18} color={Colors.red} style={styles.warningIcon} />
              <Text style={styles.warningText}>Never share your secret phrase with anyone, and store it secretly!</Text>
            </View>
          </View>
