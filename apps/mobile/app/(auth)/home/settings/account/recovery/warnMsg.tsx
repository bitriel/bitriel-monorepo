          ...
          <View className="bg-white rounded-2xl w-[80%] p-4">
            <View className="gap-3">
              <View className="gap-2">
                <Text className="text-center text-xl text-darkBlue font-SpaceGroteskBold">Show secret recovery phrase</Text>
              ...
              <View className="flex-row justify-center gap-2">
                <TouchableOpacity className="flex-1 bg-gray-100 p-3 rounded-lg" onPress={() => setVisible(false)}>
