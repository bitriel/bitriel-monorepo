...
export default function CustodialLoginScreen() {
  const [email, setEmail] = useState("");
  const [password, setPassword] = useState("");
  const [showPassword, setShowPassword] = useState(false);
  const { login, isLoading, error, clearError } = useCustodialAuthStore();
    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity onPress={() => router.push("/(public)/custodial/register")} disabled={isLoading}>
            <Text style={[styles.linkText, isLoading && styles.linkTextDisabled]}>Don't have an account? Register</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </>
