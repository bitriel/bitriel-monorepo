                    ...
                    <SafeAreaView className="mx-2 my-5">
                        <TouchableOpacity onPress={handleOpenBottomSheet}>
                            <View className="bg-yellow/20 p-4 rounded-lg flex-row justify-between items-center mb-5">
                                ...
                                <Text className="flex-1 ml-2 text-yellow">
                        ...
                        >
                            <Text className="text-darkBlue text-base font-bold text-center">
                                ...
                                <View className="bg-white p-5 rounded-lg w-4/5">
                                    <View className="gap-3">
                                        <View className="gap-2">
                                            <Text className="text-center text-xl text-darkBlue font-bold">
                                                Written the Secret Recovery Phrase down?
                                            </Text>

                                            <Text className="text-center text-base text-defaultText">
                                                Without the secret recovery phrase you will not be able to access your
                                                key or any assets associated with it.
                                            </Text>
                                        </View>
