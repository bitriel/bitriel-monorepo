  ...
  return (
    <MotiView
      ...
      <TouchableOpacity style={styles.header} onPress={() => setExpanded(!expanded)} activeOpacity={0.7}>
        ...
        <MotiView animate={{ rotate: expanded ? "180deg" : "0deg" }} transition={{ type: "timing", duration: 300 }}>
          ...
          <View style={styles.slippageOptions}>
            {predefinedSlippages.map((value) => (
              <TouchableOpacity
                ...
                <Text style={[styles.slippageOptionText, slippage === value && styles.slippageOptionTextSelected]}>{value}%</Text>
              </TouchableOpacity>
            ))}
          </View>

          <View style={styles.infoRow}>
            <Text style={styles.infoText}>Your transaction will revert if the price changes unfavorably by more than this percentage.</Text>
          </View>
