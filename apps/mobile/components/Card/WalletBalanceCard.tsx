...
export default function WalletBalanceCard({ address, totalBalance, onCopyAddress, quickActions, networkName }: WalletBalanceCardProps) {
    ...
    <View style={{ alignItems: "center", marginVertical: 10 }}>
      <View
        ...
        <View style={{ flex: 1, justifyContent: "space-between" }}>
          {/* Top Section */}
          <View>
            <TouchableOpacity style={{ flexDirection: "row", alignItems: "center" }} onPress={() => address && onCopyAddress?.(address)}>
              <Text className="font-SpaceGroteskBold text-white text-base" numberOfLines={1}>
                {address ? truncateString(address, 9, 9) : "N/A"}
              </Text>
              <MaterialCommunityIcons name="content-copy" size={16} color={Colors.white} style={{ marginLeft: 5 }} />
            </TouchableOpacity>
            <View style={{ marginTop: _spacing }}>
              <Text className="font-SpaceGroteskRegular" style={{ color: "white", opacity: 0.7 }}>
                Total Balance
              </Text>
              <Text className="font-SpaceGroteskBold" style={{ color: "white", fontSize: 32, fontWeight: "600" }}>
                {totalBalance}
              </Text>
            </View>
          </View>
                  ...
                  <MotiView
                    ...
                    <TouchableOpacity
                      ...
                      <View
                        ...
                        <MaterialCommunityIcons name={getIconForType(action.icon)} size={30} color={Colors.white} />
                        <Text className="font-SpaceGroteskBold text-base text-white">{action.label}</Text>
                      </View>
                    </TouchableOpacity>
                  </MotiView>
                );
