    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <TouchableOpacity onPress={handleBackPress} disabled={!webViewRef.current?.goBack}>
          <Iconify icon="solar:alt-arrow-left-line-duotone" size={24} color={!webViewRef.current?.goBack ? "gray" : "black"} />
        </TouchableOpacity>
        <TouchableOpacity onPress={handleForwardPress} disabled={!webViewRef.current?.goForward}>
          <Iconify icon="solar:alt-arrow-right-line-duotone" size={24} color={!webViewRef.current?.goForward ? "gray" : "black"} />
        </TouchableOpacity>
