...
import QRScanner from "~/app/(auth)/home/qrScanner";

import { isValidAddress } from "~/src/utilities/validators";
      ...
      <View className="mb-4 rounded-2xl bg-white p-4 shadow-sm">
        ...
        <View className="mb-3 flex-row">
          <TextInput
            ...
            editable={!isLoading}
          />
          <TouchableOpacity className={`rounded-xl bg-blue-500 p-3 ${isLoading ? "opacity-50" : ""}`} onPress={handleScan} disabled={isLoading}>
        ...
        <TouchableOpacity
          ...
          {isLoading ? <ActivityIndicator color="white" /> : <Text className="text-center font-medium text-white">Send</Text>}
        </TouchableOpacity>
      </View>
