...
export default function LoadingModal({ modalVisible = false, color, task, title, fontFamily, darkMode = false, modalStyle, textStyle }: Props) {
  return (
    <Modal animationType="fade" transparent={true} visible={modalVisible} statusBarTranslucent={true}>
      <View style={styles.centeredView}>
        <View style={[styles.modalView, darkMode && { backgroundColor: "#121212" }, modalStyle]}>
          ...
          <Text style={[styles.modalText, { fontFamily: "SpaceGrotesk-SemiBold" }, darkMode && { color: "white" }, textStyle]}>
            {title ? title + " " : ""}
